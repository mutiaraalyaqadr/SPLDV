...
<body>
  ...
  <main class="container">
    <div class="title-container">
      <h1 class="title">Soal<br>1</h1>
    </div>
    <div class="soal-container">
      <img src="gambar/soal1.png" alt="" class="soal-img">
      <div class="jawaban-container">
        <button class="jawaban-btn" data-benar="salah">I</button>
        <button class="jawaban-btn" data-benar="salah">II</button>
        <button class="jawaban-btn" data-benar="benar">III</button>
        <button class="jawaban-btn" data-benar="salah">IV</button>
      </div>
    </div>
    <div class="penjelasan-container hidden">
      <img src="gambar/jaw1.png" alt="penjelasan" class="penjelasan-img">
      <a href="soal-2.php" class="lanjut-btn">Lanjut</a>
    </div>
  </main>

...
<body>
    ...
    <main class="container">
        <div class="title-container">
            <h1 class="title">Soal<br>3</h1>
        </div>
        <div class="soal-container">
            <img src="gambar/soal3.png" alt="" class="soal-img">
            <div class="jawaban-container">
                <button class="jawaban-btn" data-benar="salah">{4, 8}</button>
                <button class="jawaban-btn" data-benar="salah">{12, 4}</button>
                <button class="jawaban-btn" data-benar="salah">{4, 12}</button>
                <button class="jawaban-btn" data-benar="benar">{8, 4}</button>
            </div>
        </div>
        <div class="penjelasan-container hidden">
            <img src="gambar/jaw3.png" alt="penjelasan" class="penjelasan-img">
            <a href="soal-4.php" class="lanjut-btn">Lanjut</a>
        </div>
    </main>

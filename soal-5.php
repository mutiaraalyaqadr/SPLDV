...
<body>
  ...
  <main class="container">
    <div class="title-container">
      <h1 class="title">Soal<br>5</h1>
    </div>
    <div class="soal-container">
      <img src="gambar/soal5.png" alt="" class="soal-img">
      <div class="jawaban-container">
        <button class="jawaban-btn" data-benar="salah">2p - 2l = 64</button>
        <button class="jawaban-btn" data-benar="salah">p x l = 64</button>
        <button class="jawaban-btn" data-benar="benar">2p + 2l = 64</button>
        <button class="jawaban-btn" data-benar="salah">p + l = 64</button>
      </div>
    </div>
    <div class="penjelasan-container hidden">
      <img src="gambar/jaw5.png" alt="penjelasan">
      <a href="latihandepan.php" class="selesai-btn">Selesai</a>
    </div>
  </main>

...
<body>
  ...
  <main class="container">
    <div class="title-container">
      <h1 class="title">Soal<br>4</h1>
    </div>
    <div class="soal-container">
      <img src="gambar/soal4.png" alt="" class="soal-img">
      <div class="jawaban-container">
        <button class="jawaban-btn" data-benar="benar">3x + 2y = 65.000</button>
        <button class="jawaban-btn" data-benar="salah">3x - 2y = 65.000</button>
        <button class="jawaban-btn" data-benar="salah">3x + 2y = 65</button>
        <button class="jawaban-btn" data-benar="salah">3x - 2y = 65</button>
      </div>
    </div>
    <div class="penjelasan-container hidden">
      <img src="gambar/jaw4.png" alt="penjelasan" class="penjelasan-img">
      <a href="soal-5.php" class="lanjut-btn">Lanjut</a>
    </div>
  </main>
